...
const string HELP_KEY_IGNORED_WARNING =
    "Warning: The \"--help\" key is ignored when not placed after the command "
    "declaration.";
const string HELP_KEY_TYPED_WARNING =
    "Warning: The \"--help\" key was typed. Other data of input was ignored.";

const string LIMIT_ARGUMENT_EXCEPTION =
    "Error: number of command's argument exceeded.";
...
const string ARGUMENT_MISSING_VALUE_EXCEPTION =
    "Error: missing value for argument.";
const string ARGUMENT_DOESNT_EXISTS_EXCEPTION =
    "Error: command's argument doesn't found.";
const string ARGUMENT_NOT_FOUND_EXCEPTION =
    "Error: command's argument doesn't found.";
...
const string DIRECTORY_ALREADY_EXISTS_EXCEPTION =
...
const string COMMAND_INCORRECT_PARAMETRS_EXCEPTION =
    "Error: command has an incorrect parametr.";
const string COMMAND_EXECUTION_EXCEPTION =
    "Command execution ended with an error.";

const string INVALID_TYPE_OBJECT_EXCEPTION = "Error: type object is invalid.";

inline void write_error(const string &error, const string &reason) {
  cerr << format("{} => {}", error, reason) << endl;
}

inline void throw_error(const string &error, const string &reason) {
